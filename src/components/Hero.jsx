      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            {/* sub */}
            <p className="text-base sm:text-lg text-gray-400 leading-relaxed max-w-lg animate-fadeInUp delay-200">
              {subheadline ??
          ...
          {/* ── RIGHT (chat preview) ── */}
          <div className="hidden lg:flex justify-center items-center animate-fadeInUp delay-300">
            <div className="relative animate-float">

              {/* card */}
              <div className="glass rounded-3xl p-6 w-[320px] glow-green">
                ...
                {/* disclaimer chip */}
                <div className="p-2.5 rounded-xl bg-amber-900/20 border border-amber-700/20">
